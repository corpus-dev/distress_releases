...
- automatic update of targets from IT Corpus UA
...
download and run [the latest binary](https://github.com/corpus-dev/distress_releases/releases/latest/download/distress_x86_64-pc-windows-msvc.exe)
